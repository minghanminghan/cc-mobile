...
export default function ProfileList({ onConnect, onEdit, onNew, error }: Props) {
  ...
  return (
    <div className="flex items-center justify-center w-screen h-screen bg-black overflow-y-auto">
      <div className="w-full max-w-2xl p-8 mt-16 max-h-[90vh]">
        {error && (
          <div className="flex items-start gap-3 bg-red-950/40 border border-red-900/50 rounded-lg px-4 py-3 mb-6">
            <svg className="text-red-400 shrink-0 mt-0.5" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
